...
double macrocirculation::BaseAssembly::compute_qoi(const std::string &type, unsigned int local_var_id) {
  ...
  auto var_fe_type = d_sys.variable_type(0);
...
void macrocirculation::BaseAssembly::project_physical_range(unsigned int local_var_id, double min, double max) {
