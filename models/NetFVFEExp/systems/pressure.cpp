...
Number netfvfeexp::initial_condition_pres(const Point &p, const Parameters &es,
...
void netfvfeexp::boundary_condition_pres(EquationSystems &es) {
...
void netfvfeexp::PressureAssembly::assemble() {
  assemble_1d_coupling();
  assemble_face();
  assemble_1();
}

void netfvfeexp::PressureAssembly::assemble_1d_coupling() {
...
void netfvfeexp::PressureAssembly::assemble_face() {
...
void netfvfeexp::PressureAssembly::assemble_1() {
