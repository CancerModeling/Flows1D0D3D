...
Number netfvfeexp::initial_condition_nut(const Point &p, const Parameters &es,
...
void netfvfeexp::boundary_condition_nut(EquationSystems &es) {
...
// Assembly class
void netfvfeexp::NutAssembly::assemble() {
  assemble_1d_coupling();
  assemble_face();
  assemble_1();
}

void netfvfeexp::NutAssembly::assemble_1d_coupling() {
...
void netfvfeexp::NutAssembly::assemble_face() {
