...
void netfcfvfe::Network::assemble3DSystemForTAF(){
...
void netfcfvfe::Network::solve3DTAFProblem( int timeStep, double time ){
...
double netfcfvfe::Network::sourceTermTAFTwoVessels( std::vector<double> coord ){
...
void netfcfvfe::Network::writeDataToVTK3D_TAF(std::vector<double> phi_TAF_3D, int N_3D, double h_3D, int timeStep){
