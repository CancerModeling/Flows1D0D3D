...
void netfcfvfe::Network::readData( std::vector<std::vector<double>> &vertices, std::vector<double> &pressures,
...
void netfcfvfe::Network::transferDataToVGM( std::vector<std::vector<double>> &vertices, std::vector<double> &pressures,
                                        std::vector<double> &radii, std::vector<std::vector<unsigned int>> &elements ) {
...
void netfcfvfe::Network::printDataVGM() {
...
void netfcfvfe::Network::rescaleSecombData( std::vector< std::vector<double> >& vertices, std::vector<double>& pressures, std::vector<double>& radii, double epsilon ){
...
void netfcfvfe::Network::refine1DMesh() {
...
void netfcfvfe::Network::writeDataToVTK_3D(std::vector<double> P_3D, int N_3D, double h_3D) {
