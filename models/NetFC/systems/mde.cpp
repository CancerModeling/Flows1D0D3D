...
void netfc::boundary_condition_mde(EquationSystems &es) {

  const auto *deck = es.parameters.get<netfc::InputDeck *>("input_deck");
}

void netfc::MdeAssembly::assemble() {
...
void netfc::MdeAssembly::assemble_1() {
...
void netfc::MdeAssembly::assemble_2() {
...
void netfc::MdeAssembly::assemble_3() {
