...
void netfc::Network::create_initial_network() {
...
void netfc::Network::writeDataToVTKTimeStep_VGM(int timeStep) {
...
void netfc::Network::assemble3D1DSystemForPressure() {
...
void netfc::Network::assemble3D1DSystemForNutrients() {
...
void netfc::Network::assembleVGMSystemForNutrients() {
...
void netfc::Network::solve3D1DNutrientProblem(int timeStep, double time) {
...
void netfc::Network::solveVGMforNutrient(int timeStep, double time) {
...
double netfc::Network::getDirichletValue(std::vector<double> center_face, double L_p, double radius) {
...
double netfc::Network::getK1D(double s, double L_p, double radius) {
...
void netfc::Network::solve3D1DFlowProblem(int timeStep, double time) {
...
void netfc::Network::writeDataToVTK3D_Pressure(std::vector<double> P_3D, std::vector<std::vector<double>> V_3D, int N_3D, double h_3D, int timeStep) {
...
void netfc::Network::writeDataToVTK3D_Nutrients(std::vector<double> phi_sigma_3D, int N_3D, double h_3D, int timeStep) {
