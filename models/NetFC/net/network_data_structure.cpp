  ...
  for (int i = 0; i < N_3D; i++) { // x-loop
    ...
    for (int j = 0; j < N_3D; j++) { // y-loop
      ...
      for (int k = 0; k < N_3D; k++) { // z-loop
        ...
        filevtk << "8"
                << " " << getIndex(center[0] - 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] - 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] - 0.5 * h_3D, h_3D) << " " << getIndex(center[0] + 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] - 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] - 0.5 * h_3D, h_3D) << " " << getIndex(center[0] - 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] + 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] - 0.5 * h_3D, h_3D) << " " << getIndex(center[0] + 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] + 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] - 0.5 * h_3D, h_3D) << " " << getIndex(center[0] - 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] - 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] + 0.5 * h_3D, h_3D) << " " << getIndex(center[0] + 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] - 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] + 0.5 * h_3D, h_3D) << " " << getIndex(center[0] - 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] + 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] + 0.5 * h_3D, h_3D) << " " << getIndex(center[0] + 0.5 * h_3D, h_3D) * (N_3D + 1) * (N_3D + 1) + getIndex(center[1] + 0.5 * h_3D, h_3D) * (N_3D + 1) + getIndex(center[2] + 0.5 * h_3D, h_3D) << std::endl;
      }
    }
  }
