...
def input():
    ...
    break_points.append(len(param_val))
    break_msg.append('\n# nutrient')
    add(param_index, param_val, 'lambda_P', 4.)
    ...
    add(param_index, param_val, 'chi_c', 0.005)

    # tumor
    break_points.append(len(param_val))
    break_msg.append('\n# tumor')
    add(param_index, param_val, 'bar_M_P', 100.)
    ...
    add(param_index, param_val, 'sigma_PH', 0.12)
    add(param_index, param_val, 'sigma_HP', 0.2)
    add(param_index, param_val, 'sigma_HN', 0.1)
    ...
    break_points.append(len(param_val))
    break_msg.append('\n# nutrient ic')
    add(param_index, param_val, 'ic_nutrient_value', 0.1)
