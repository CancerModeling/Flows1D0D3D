...
def gen_init_network_file(filename):
    ...
    inpf.write("{} {} {} {}\n".format(0.2, 0.2,  0.0, 5.0))
    inpf.write("{} {} {} {}\n".format(0.2, 0.2,  1.0, 10.0))
    inpf.write("{} {} {} {}\n".format(0.8, 0.8,  0.0, 2.0))
    inpf.write("{} {} {} {}\n".format(0.8, 0.8,  1.0, 1.0))

    # segments
    inpf.write("#\n")
    inpf.write("SIMPLEX\n")
    inpf.write("parameters {}\n".format(2))
    inpf.write("{} {} {} {}\n".format(0, 1, 0.1, 0.0075))
    inpf.write("{} {} {} {}\n".format(2, 3, 0.05, 0.0075))
    # 
    inpf.write("#\n")
...
def input():
    ...
    add(param_index, param_val, 'domain_xmin', 0.0)
    add(param_index, param_val, 'domain_xmax', L)
    add(param_index, param_val, 'domain_ymin', 0.0)
    add(param_index, param_val, 'domain_ymax', L)
    add(param_index, param_val, 'domain_zmin', 0.0)
    ...
    add(param_index, param_val, 'linear_solver_tol', 1.0e-10)
    add(param_index, param_val, 'nonlinear_solver_max_iter', 100)
    add(param_index, param_val, 'nonlinear_solver_tol', 1.0e-10)
    ...
    add(param_index, param_val, 'D_sigma', 0.1)
    ...
    break_points.append(len(param_val))
    break_msg.append('\n# flow 1D')
    add(param_index, param_val, 'init_vessel_viscosity', 1.0e-2)
    ...
    break_points.append(len(param_val))
    break_msg.append('\n# flow 21/3DD')
    add(param_index, param_val, 'tissue_flow_viscosity', 1.0)
    add(param_index, param_val, 'tissue_flow_K', 1.0)
    add(param_index, param_val, 'tissue_flow_density', 1.0)
    add(param_index, param_val, 'tissue_flow_L_p', 0.01)
    add(param_index, param_val, 'tissue_nut_L_s', 1.0)
