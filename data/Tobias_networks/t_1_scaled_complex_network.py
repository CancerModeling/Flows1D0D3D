...
def network_input(L, param_index, param_val):
    ...
    add(param_index, param_val, 'network_init_file', '/home/m2rechner/Documents/svn_projects/Project_TumorGrowth/TGModels.git/branches/coupled-pressure/build/NetTum/network_files/ratbrain_secomb.dgf')
